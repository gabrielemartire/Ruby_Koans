...
class AboutClassMethods < Neo::Koan
  ...
  def test_override_instance_method
    duchessa = Cat.new
    def duchessa.miao
      :miao!
    end
  ...
  def test_classes_and_instances_do_not_share_instance_variables
    ...
    assert_equal " II", Dog.name # @name exists only in instance Dog.name
  end
  ...
  class Dog #NOTA ho riaperto Dog (precedentemente definito)
    def a_super_cool_class_method #NOTA non facendo self. sto creando un metodo di instanza e non di classe,
      :dogs_class_method_superiperwow # e cioè un metodo che esiste solo qui dentro
    end
  end
  ...
  #NOTA the self. method need less code rows
