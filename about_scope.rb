...
class AboutScope < Neo::Koan
  ...
  # Class Dog not available here because its in the Module
  ...
  def test_bare_bones_class_names_assume_the_current_scope
    assert_equal true, AboutScope::String == String #NOTA
  end
  ...
  # String è il nome della classe non è stringa come Simbolo
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    assert_equal [:Dog], Jims.constants #NOTA
